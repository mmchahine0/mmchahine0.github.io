...
import netways from "../assets/images/netways.png";
...
export const skills = [
  ...
  },
  {
    ...
    icon: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/microsoft.svg",
    color: "lightBlue",
    projectsMade: ["Enterprise business apps", "Current role"],
  },
  {
    name: "Power Platform",
    icon: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/microsoft.svg",
    color: "lightBlue",
    projectsMade: ["Power Apps", "Power Automate", "Current role"],
  },
  {
    name: "Dataverse",
    icon: "https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/microsoft.svg",
    color: "lightBlue",
    projectsMade: ["Data modeling", "Enterprise apps", "Current role"],
  },
...
export const experiences = [
  {
    icon: netways,
    company: "Netways",
    link: "https://www.linkedin.com/school/netways",
    role: "Software Developer (Web & Dynamics 365)",
    responsibility:
      "Developed enterprise-grade applications using Microsoft Dynamics 365, .NET, and React with strong emphasis on data modeling and business logic.",
    period: "August 2025 - Present",
  },
  {
    icon: eTech,
    company: "3E Tech",
    link: "https://www.linkedin.com/company/tech-3e",
    role: "Full Stack Developer",
    responsibility:
      "Implemented various features in the company's main project with a team using React.js, Node.js, Express.js, and TypeScript.",
    period: "January 2025 - March 2025",
  },
  {
    icon: twoOfUs,
    company: "Two Of Us L.L.C",
    link: "https://www.linkedin.com/company/two-of-us-cooperation",
    role: "Front-end Developer",
    responsibility:
      "Engaged in a four-months intensive internship completed multiple projects in React.js developing dynamic web applications",
    period: "April 2024 - August 2024",
  },
  {
    icon: techlarious,
    company: "TECHlarious",
    link: "https://www.linkedin.com/school/techlarious",
    role: "Full Stack Developer",
    responsibility:
      "Intensive training bootcamp champion in Full Stack using MERN Stack, MongoDB, Express, React, Node.",
...
export const education = [
  ...
  },
  {
    ...
    link: "https://learn.microsoft.com/en-us/certifications/pl-200-power-platform-functional-consultant-associate/",
    year: "2026",
  },
];
